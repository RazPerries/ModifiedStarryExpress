...
This mod is intended to be played in the WATHE Modpack alongside other addon mods, like Stupid Express and Noelle's Roles, but it will work just fine without other addon mods installed.

## The Guidebook
Learn about Roles and Modifiers from WATHE and other addon mods, all from a user-friendly GUI opened from the top left of your inventory!
<details>
<summary>Guidebook-Supported Addon Mods</summary>

- [Noelle's Roles](https://modrinth.com/mod/noelles-roles-tmm)
...
## For Server Owners
### Configuration
Starry Express aims to be as configurable as possible, and thus, contains server-sided config for server owners to change to their heart's content.

You can find this config at ```config/starexpress-server.json5``` in your server's files.
